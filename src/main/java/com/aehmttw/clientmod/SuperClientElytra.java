...
public class SuperClientElytra implements LayerRenderer<EntityLivingBase>
{
    ...
    public SuperClientElytra(RenderLivingBase<?> p_i47185_1_)
    {
    ...
    public void doRenderLayer(EntityLivingBase entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
        ...
        if (itemstack.getItem() == Items.ELYTRA)
        {
            ...
            if (entitylivingbaseIn instanceof AbstractClientPlayer)
            {
                ...
                else if (SuperClientCape.getCape(abstractclientplayer) != null && abstractclientplayer.isWearing(EnumPlayerModelParts.CAPE))
                {
                    this.renderPlayer.bindTexture(SuperClientCape.getCape(abstractclientplayer));
                }
